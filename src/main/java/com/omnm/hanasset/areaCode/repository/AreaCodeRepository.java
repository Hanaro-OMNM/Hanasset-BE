...
import com.omnm.hanasset.marker.dto.CurrentMarkersDTO;
import com.omnm.hanasset.marker.dto.ShowAreaCodeDTO;
...
public interface AreaCodeRepository extends JpaRepository<AreaCode, Long> {
    ...
    @Query("""
    SELECT new com.omnm.hanasset.marker.dto.CurrentMarkersDTO(co.code, co.cityName, co.sigunguName, co.emdName)
    FROM AreaCode co
    WHERE (co.address LIKE '%별시'
        OR co.address LIKE '%역시'
        OR co.address LIKE '%도')
